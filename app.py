        ...
        st.markdown("""
            <div class="landing-container">
                <div style="text-align: center; margin-bottom: 10px;">
                    <span style="background-color: #2c3e50; color: white; padding: 6px 15px; border-radius: 50px; font-size: 11px; font-weight: bold; text-transform: uppercase;">
                        TFM • Máster en Inteligencia Artificial aplicada a la salud
                    </span>
                </div>

                <div style="text-align: center; color: #555; font-size: 13px; font-weight: 700; text-transform: uppercase; margin-bottom: 5px;">
                ...
                <div class="warning-box">
                    <p><strong>
                        Aplicación desarrollada con fines exclusivamente educativos.
                    </strong></p>
                    <p style="margin-top:10px;">
                        ⚠️ Esta herramienta NO es un dispositivo médico certificado.
                        Los resultados son una simulación académica.
                    </p>
                </div>
            </div>
        """, unsafe_allow_html=True)
...
# =========================================================
    ...
    st.markdown(f"""
        ...
        .card-header {{
            color: #999; font-size: 0.75rem; font-weight: bold;
    ...
    with tab1:
        ...
        if distancia_al_corte > 0.15:
            conf_text, conf_color, conf_desc = "ALTA", GOOD_TEAL, "Clasificación robusta."
        elif distancia_al_corte > 0.05:
            conf_text, conf_color, conf_desc = "MEDIA", "#F39C12", "Probabilidad cercana al umbral."
        else:
            conf_text, conf_color, conf_desc = "BAJA", CEMP_PINK, "Zona de incertidumbre clínica."
