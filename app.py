...
# =========================================================
    ...
    with st.sidebar:
        ...
        # -------------------------------------------------------------
        # NUEVA SECCIÓN: NOMBRE Y FECHA
        # -------------------------------------------------------------
        st.markdown("**Datos del Paciente**")
        patient_name = st.text_input("Nombre / ID", value="Paciente #8842-X", label_visibility="collapsed", placeholder="Nombre del paciente")
        
        col_date_label, col_date_input = st.columns([1,2])
        consult_date = st.date_input("Fecha", value=datetime.date(2025, 12, 14), label_visibility="collapsed")
        
        # Lógica para formatear la fecha estilo "14 Dic 2025"
    ...
    with tab1:
        ...
        with c_left:
            # =========================================================
            # TARJETA EXPEDIENTE CON VARIABLES ACTUALIZADAS
            # =========================================================
