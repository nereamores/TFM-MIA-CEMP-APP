...
# =========================================================
st.set_page_config(
    page_title="Diabetes NME", # Restaurado del código 1
    page_icon="🩸",
    layout="wide"
)
...
class MockModel:
    def predict_proba(self, X):
        # Simulación simple (Estructura del código 2)
...
def volver_inicio():
    st.session_state.page = "landing"
    st.session_state.predict_clicked = False # Restaurado reset al volver
...
# =========================================================
    ...
    st.markdown(f"""
        ...
        /* Estilos mejorados para Expanders del código 2 */
    ...
    with st.sidebar:
        ...
        # 1. GLUCOSA E INSULINA (Restaurando defaults del código 1)
        ...
        # Restaurando format_str del código 1
