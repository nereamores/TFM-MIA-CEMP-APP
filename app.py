...
# =========================================================
# 3. PÁGINA: PORTADA (TEXTO ORIGINAL RESTAURADO)
# =========================================================
if st.session_state.page == "landing":
    ...
    # HTML DE LA PORTADA (TEXTO ORIGINAL)
    st.markdown("""
...
# =========================================================
    ...
    def input_biomarker(label_text, min_val, max_val, default_val, key, help_text="", format_str=None):
        ...
        # Si no se pasa formato, inferimos
        ...
        with c2:
            st.number_input(
                ...
                format=format_str # Formato limpio sin comas
            )
    ...
    with st.sidebar:
        ...
        # Formateamos el proxy para que NO tenga comas (ej: 12000)
